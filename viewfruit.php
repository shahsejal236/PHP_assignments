                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">UI ELEMENTS
                                    <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="ui.html">UI
                                            ELEMENTS</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#">EXAMPLE LINK</a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="panel-body">
                           ...
                           foreach($fruit_arr as $data)
                          {
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <?php if(!isset($_GET['action'])) { ?>
                                            <td> 
                                                    <a href="edit?edit_fruit_id=<?php echo $data->id;?>"class="btn btn-primary">Edit</a>
                                                <?php } ?>
                                                <a href="delete?del_fruit_id=<?php echo $data->id;?>"class="btn btn-danger">Delete</a>
                                                <?php } ?>
